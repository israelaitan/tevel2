...
typedef enum __attribute__ ((__packed__)) management_subtypes_t
{
	...
	ANTS_SIDE_A_RESET_SUBTYPE=	0x88,
	ANTS_SIDE_B_RESET_SUBTYPE=	0x89,
	ANTS_AUTO_DEPLOY_SUBTYPE=	0x90,
	ANTS_CANCEL_DEPLOY_SUBTYPE = 0xB7,		//0b10110111
	I2C_GEN_CMD_SUBTYPE=		0x91,
	FRAM_READ_SUBTYPE=  		0x92,
	FRAM_WRITE_SUBTYPE=			0x93,
	FRAM_RESTART_SUBTYPE=		0x94,
	UPDATE_SAT_TIME_SUBTYPE= 	0x95,
	GET_SAT_TIME_SUBTYPE= 		0x96,
	GET_SAT_UP_TIME_SUBTYPE= 	0x97,
	TLM_SET_COLL_CYCLE_SUBTYPE= 0x98
